...
## Purpose
Contrato público de extensibilidad (`GitExtensions.Extensibility`) neutro respecto a la
tecnología de UI: define qué puede ofrecer y consumir un plugin sin acoplarse a
WinForms/GDI+, de modo que cualquier shell (WinForms hoy, Avalonia en el futuro) pueda
materializar los conceptos de UI (ventanas, iconos, settings) con sus propios tipos.
## Requirements
