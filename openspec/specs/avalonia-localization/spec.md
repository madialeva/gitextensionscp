...
Proporciona una localización portable y observable para la shell Avalonia, reutilizando los catálogos de traducción existentes sin acoplarla a WinForms ni a `ResourceManager`.
