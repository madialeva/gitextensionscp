...
public class MessageBoxes : Translate
{
    ...
    public static DialogResult Show(IWin32Window? owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton = MessageBoxDefaultButton.Button1)
        => GitExtUtils.MessageBoxes.Show(owner.AsApiWindow(), text, caption, buttons, icon, defaultButton);
    ...
    public static DialogResult Show(IWin32Window? owner, string text, string caption, MessageBoxButtons buttons)
        => GitExtUtils.MessageBoxes.Show(owner.AsApiWindow(), text, caption, buttons);
    ...
    public static DialogResult Show(string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton)
        => GitExtUtils.MessageBoxes.Show(text, caption, buttons, icon, defaultButton);
    ...
    public static DialogResult Show(string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon)
        => GitExtUtils.MessageBoxes.Show(text, caption, buttons, icon);
    ...
    public static DialogResult Show(string text, string caption, MessageBoxButtons buttons)
        => GitExtUtils.MessageBoxes.Show(text, caption, buttons);
}
