...
#pragma warning disable RS0030 // Do not use banned APIs -- MessageBoxes is the approved wrapper
    public static DialogResult Show(IWindow? owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton = MessageBoxDefaultButton.Button1)
        => MessageBox.Show(owner as IWin32Window ?? Form.ActiveForm, text, caption, buttons, icon, defaultButton);
#pragma warning restore RS0030
    ...
    /// </summary>
    /// <returns>The <see cref="DialogResult"/> selected by the user.</returns>
    public static DialogResult Show(IWindow? owner, string text, string caption, MessageBoxButtons buttons)
    ...
    /// </summary>
    public static void ShowError(IWindow? owner, string text, string? caption = null)
    ...
    public static bool Confirm(IWindow? owner, string text, string caption, MessageBoxIcon icon = MessageBoxIcon.Question, MessageBoxDefaultButton defaultButton = MessageBoxDefaultButton.Button1)
